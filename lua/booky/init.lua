...
function M.setup(opts)
	...
	vim.api.nvim_create_user_command("BookyGlobal", function()
		M.open_global_bookmarks()
	end, { desc = "Open global bookmarks in floating window" })
	...
	vim.keymap.set("n", config.options.keymaps.toggle_telescope, function()
		M.open_telescope()
	end, vim.tbl_extend("force", keymap_opts, { desc = "Open project bookmarks in telescope" }))
...
-- Open telescope bookmark picker (project-specific)
function M.open_telescope()
	local telescope = require("booky.telescope")
	telescope.open_bookmark_picker(false) -- false = project-specific
end

-- Open global bookmarks in floating window
function M.open_global_bookmarks()
	local floating = require("booky.floating")
	floating.open_global_bookmarks()
end
